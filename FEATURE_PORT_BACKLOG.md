...
### Wave 7 — Boxing Skill — **Done**

| ID | Feature | Status |
|---|---|---|
| K1 | Boxing skill shell and static ring | **Done** |
| K2 | Fighter glove / target authoring marks | **Done** |
| K3 | Versioned design-derived divisions | **Done** |
| K4 | Opponent-only non-solving hit probes | **Done** |
